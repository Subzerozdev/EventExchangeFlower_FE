...
const testimonials = [
  {
    content: '“Dịch vụ của Hoa Lối Cũ thật sự tuyệt vời! Tôi đã đặt một bó hoa cho ngày sinh nhật của mẹ và kết quả thật đáng kinh ngạc. Hoa tươi, được bó rất đẹp và chất lượng hoàn toàn vượt ngoài mong đợi. Chắc chắn tôi sẽ tiếp tục sử dụng dịch vụ trong tương lai!”',
    author: 'Chị Nguyễn Thị Lan Anh',
    location: 'Bình Dương',
    image: 'https://th.bing.com/th/id/OIP.0yjWQLJmtSeg1EnL1MfLVgHaJI?rs=1&pid=ImgDetMain', // URL ảnh của khách hàng
  },
  {
    content: '“Hoa Lối Cũ đã giúp tôi gửi đi một bó hoa tươi tuyệt đẹp cho đối tác của mình. Rất nhanh chóng và chất lượng cao!”',
    author: 'Anh Lê Minh Nghĩa',
    title: 'CEO of Diamond Coin',
    image: 'https://media.yeah1.com/files/ngoctran/2022/07/01/289693821_582015943280803_2102006602626651935_n-205941.jpg', // URL ảnh của khách hàng
  },
  {
    content: '“Dịch vụ tại đây rất tuyệt vời, tôi sẽ giới thiệu cho bạn bè mình!”',
    author: 'Nguyễn Văn Bảo',
    location: 'Đồng Nai',
    image: 'https://th.bing.com/th/id/OIP.6RRfL6mRhmtl54O0HdU78wHaLH?rs=1&pid=ImgDetMain', // URL ảnh của khách hàng
  },
];
const images = [
...
const steps = [
  {
    ...
    icon: <CheckCircleOutlined style={{ fontSize: '24px', color: '#FFD700' }} />,
  },
  {
    title: 'Bước 2: Thanh toán đơn giản',
    description: 'Thanh toán trực tuyến qua QR VNPAY, hỗ trợ mọi ngân hàng tại Việt Nam hoặc thanh toán trực tiếp khi nhận hàng.',
      ...
      <section className="support-section">
        ...
        <div className="support-features">
          <div className="feature">
            <img src="https://firebasestorage.googleapis.com/v0/b/swphoathanhly.appspot.com/o/Hoa%2FCarousel%2FLogo%20Support%2F4.png?alt=media&token=f07c75fd-3d16-4879-a399-e1e437ddcdf7" alt="VAT Support" />
            <h3>Xuất hóa đơn VAT</h3>
            <p>Xuất VAT trong ngày! (8%)</p>
          </div>
          <div className="feature">
            <img src="https://firebasestorage.googleapis.com/v0/b/swphoathanhly.appspot.com/o/Hoa%2FCarousel%2FLogo%20Support%2F5.png?alt=media&token=0e90483f-d6c2-4561-90af-62be7ce4ea93" alt="On-Time Delivery" />
            <h3>Giao hàng đúng giờ</h3>
            <p>Cam kết giao hàng đúng giờ, đảm bảo sản phẩm luôn tươi</p>
          </div>
          <div className="feature">
            <img src="https://firebasestorage.googleapis.com/v0/b/swphoathanhly.appspot.com/o/Hoa%2FCarousel%2FLogo%20Support%2F6.png?alt=media&token=a114de93-0e1a-494a-a322-ae359cf92d1b" alt="Quality First" />
            <h3>Ưu tiên chất lượng là hàng đầu</h3>
            <p>Hoa Lối Cũ luôn đề cao chất lượng hoa tươi cũng như trải nghiệm khách hàng lên hàng đầu</p>
          </div>
          <div className="feature">
            <img src="https://firebasestorage.googleapis.com/v0/b/swphoathanhly.appspot.com/o/Hoa%2FCarousel%2FLogo%20Support%2F7.png?alt=media&token=d71ea870-f2a0-4cbd-9ec9-414871f1f8c1" alt="Customer Support" />
            <h3>Hotline hỗ trợ khách hàng</h3>
            <p>Liên hệ 0922314123 để được hỗ trợ giải đáp thắc mắc, khiếu nại.</p>
          </div>
        </div>
      ...
      <section className="order-steps">
        ...
        <div className="order-content">
          ...
          <div className="product-image-container">
            <img src={"https://firebasestorage.googleapis.com/v0/b/swphoathanhly.appspot.com/o/HomePage%2FEasy%20to%20oder%2FFlower%20project%20(1).png?alt=media&token=bd38b1fa-2b02-48d1-a923-4f2b1854d69d"} alt="Hoa tươi chất lượng cao" className="product-image" />
          </div>
        </div>
      </section>
